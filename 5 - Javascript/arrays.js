...
// .join(separator) - combine all the elements in a string
...
//type of - check the data type of a variable
console.log("Data Type of Od::", typeof odd);

// .concat() - create a new array by merging two array
let odEvenCombined = odd.concat(even);
console.log("Odd and Even:", odEvenCombined);

// .toString() - convert an array to a comma-separated string
console.log("Odd and Even in String", odEvenCombined.toString());
